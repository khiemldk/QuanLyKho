					...
					<div class="dataTables_paginate paging_simple_numbers"
							...
							<ul class="pagination">
								<li class="paginate_button previous disabled"
									id="datatable_previous"><a href="<c:url value="/goods-issue/list/${crpage-1}"/>"
									...
									<c:choose>
										...
										<c:otherwise>
											<li class="paginate_button "><a
												href="<c:url value="/goods-issue/list/${loop.index}"/>">${loop.index}</a></li>
										</c:otherwise>
									</c:choose>
								...
								<li class="paginate_button next" id="datatable_next"><a
									href="<c:url value="/goods-issue/list/${crpage+1}"/>" aria-controls="datatable" data-dt-idx="7" tabindex="0">Next</a></li>
							</ul>
						</div>
				</div>
				<div class="container" >
