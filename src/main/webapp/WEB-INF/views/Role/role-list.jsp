	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12  ">
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="table-responsive">
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<c:forEach items="${listRole}" var="list" varStatus="i">
									...
									<tr class="${cssTr }">
										...
										<td class=" ">${list.getRole_name()}</td>
										<td class=" ">${list.getDescription()}</td>
										
										<td class="text-center"><a
											href='<c:url value="/role/list/edit/${list.getId() }"/>'
						...
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<ul class="pagination">
								<li class="paginate_button previous disabled"
									id="datatable_previous"><a href="<c:url value="/role/list/${crpage-1}"/>"
									...
									<c:choose>
										...
										<c:otherwise>
											<li class="paginate_button "><a
												href="<c:url value="/role/list/${loop.index}"/>">${loop.index}</a></li>
										</c:otherwise>
									</c:choose>
								...
								<li class="paginate_button next" id="datatable_next"><a
									href="<c:url value="/role/list/${crpage+1}"/>" aria-controls="datatable" data-dt-idx="7" tabindex="0">Next</a></li>
							</ul>
				...
				<div class="container">
					<a class="btn btn-app" href='<c:url value="/role/list/add"/>'> <i
...
function confirmDelete(id){
	if (confirm("Do u want to delete this record?")) {
		window.location.href= '<c:url value="/role/list/delete/"/>'+id
	}
}
